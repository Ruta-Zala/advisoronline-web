...
import { TagArticlesDocument } from './[tagName].query';
...
const variables = reactive({ page: queryPage, tag: params.tagName });
...
const title = computed(() =>
	convertSlugToString(data.value?.currentTag?.data.at(0)?.attributes?.name),
);

// This file was copied from https://unpkg.com/browse/intl-parse-accept-language@1.0.0/
// Didn't add the package as a dependency because it looked suspicious
...
export const parseAcceptLanguage = (
	...
	return languageHeaderValue
		...
		.map((lang): [number, string] => {
			const [locale = 'en', q = 'q=1'] = lang.split(';');

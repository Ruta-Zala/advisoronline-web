<template>
	<div>
		...
		<div
			class="relative overflow-hidden bg-grey-1 pt-[60px] transition-[padding] lg:pt-[113px]"
		>
			<img
				src="/images/no-ad-background-image.png"
				alt="img"
				class="absolute right-1/2 w-[1920px] min-w-max shrink-0 translate-x-1/2 lg:block"
			/>
			<slot />
		</div>
